...
const Contact = () => {
  ...
  return (
    <section
      style={{ backgroundImage: `url(${footbridge})` }}
      className="relative bg-cover bg-fixed flex-grow flex items-center justify-center"
    >
      ...
      >
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="shadow appearance-none border rounded w-full py-2 px-3 bg-gray-100 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-24"
            id="message"
            placeholder="Message"
          ></textarea>
          {errors.message && (
        ...
        <div className="flex items-center justify-end">
          <button
            className="bg-black-gradient text-white font-bold py-2 px-8 rounded-full transform transition-200 hover:scale-105 focus:translate-x-[1px] focus:translate-y-[2px] focus:outline-none focus:shadow-outline"
            type="submit"
          >
            Submit
          </button>
        ...
        {messageSent === "error" && (
          <p className="mx-auto pt-2 text-red-500">
