...
function getBlogYears(blogs) {
  ...
  let years = [...new Set(blogs.map(blog => new Date(blog.date.split('-')[2]).getFullYear()))];
...
const News = () => {
  ...
  return (
    <div className="flex-grow flex sm:flex-row flex-col-reverse bg-primary w-full">
        ...
        <SideNav title="Year" navList={getBlogYears(blogs)} currentType={currentYear} onTypeChange={handleYearChange}/>
